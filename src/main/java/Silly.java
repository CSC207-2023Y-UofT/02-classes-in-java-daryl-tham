...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in two String as its arguments.
     *
     * @param name1 first part of this Silly instance's name.
     * @param name2 second part of this Silly instance's name.
     */
